...
function readData(data = dataPro) {
    ...
    mobileHTML += `
      <div class="bg-[#1e293b] rounded-xl p-4 border border-gray-800 shadow-lg">
        ...
        <div class="flex gap-2 mt-4">
            <button onclick="updateProduct(${i}, 'mobile')" class="flex-1 py-2 bg-blue-600/10 text-blue-400 rounded-lg text-xs font-bold hover:bg-blue-600 hover:text-white transition-all">Update</button>
            <button onclick="deleteProduct(${i})" class="flex-1 py-2 bg-red-600/10 text-red-400 rounded-lg text-xs font-bold hover:bg-red-600 hover:text-white transition-all">Delete</button>
        </div>
      </div>
    `;
  }
  ...
  if (dataPro.length > 0) {
    deleteAllbtn.innerHTML = `Clear All Products (${dataPro.length})`;
...
function updateProduct(i, source = "desktop") {
  ...
  if (source === "desktop") {
    ...
    card.innerHTML = `
      <div class="space-y-3">
        <input type="text" value="${product.title}" id="mobile-title-${i}" class="w-full p-2 bg-[#0f172a] border border-gray-700 rounded-lg text-sm outline-none focus:border-blue-500 text-white" placeholder="Title">
        <input type="text" value="${product.category}" id="mobile-category-${i}" class="w-full p-2 bg-[#0f172a] border border-gray-700 rounded-lg text-sm outline-none focus:border-blue-500 text-white" placeholder="Category">
        <input type="number" value="${product.price}" id="mobile-price-${i}" class="w-full p-2 bg-[#0f172a] border border-gray-700 rounded-lg text-sm outline-none focus:border-blue-500 text-white" placeholder="Price">
        <input type="number" value="${product.discount}" id="mobile-discount-${i}" class="w-full p-2 bg-[#0f172a] border border-gray-700 rounded-lg text-sm outline-none focus:border-blue-500 text-white" placeholder="Discount">
        <div class="flex gap-2 mt-4">
